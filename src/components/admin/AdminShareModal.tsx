        ...
        <div class="p-5 space-y-4">
          ...
          <div>
            ...
            <div class="flex gap-2">
              ...
              <button onClick={copyLink} class="px-3 py-2 bg-sky-600 hover:bg-sky-500 text-white rounded-lg text-xs font-bold transition"><Icon name="copy" /></button>
            </div>
          </div>
          ...
          <div class="flex gap-2">
            <button onClick={copyWA} class="flex-1 py-2.5 bg-[#25D366] hover:bg-[#1fbd5b] text-white rounded-xl text-xs font-bold transition"><Icon name="whatsapp" class="mr-1" />{t('ui.share_copas_wa')}</button>
            <a href={shareUrl} target="_blank" class="flex-1 py-2.5 bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-xs font-bold text-center transition"><Icon name="external-link-alt" class="mr-1" />{t('ui.share_open_view')}</a>
          </div>
        </div>
      </div>
    </div>
