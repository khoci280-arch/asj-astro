      ...
      <div id="bottom-nav-admin" class="md:hidden fixed bottom-0 left-0 right-0 bg-slate-950 border-t border-slate-800 z-[90] pb-safe">
        <div class="flex justify-between items-center px-4 py-3">
          <button onClick={() => {
            ...
            <i class="fas fa-bars text-lg mb-1 group-active:scale-90 transition"></i>
    ...
    <div id="bottom-nav-kandidat" class="md:hidden fixed bottom-0 left-0 right-0 bg-slate-950 border-t border-slate-800 z-[90] pb-safe">
      <div class="flex justify-around items-center px-6 py-3">
        <a href="/public" class="flex flex-col items-center text-slate-400 hover:text-white transition group">
          <i class="fas fa-globe text-lg mb-1 group-active:scale-90 transition"></i>
          <span class="text-[9px] font-bold">{t('ui.search_job')}</span>
        </a>
        <a href="/candidate" class="relative -top-5 flex flex-col items-center group">
          <div class="w-14 h-14 bg-emerald-600 rounded-full flex items-center justify-center text-white border-4 border-slate-950 shadow-lg group-active:scale-95 transition">
        ...
        <button onClick={handleLogout} class="flex flex-col items-center text-slate-400 hover:text-red-400 transition group">
          <i class="fas fa-power-off text-lg mb-1 group-active:scale-90 transition"></i>
          <span class="text-[9px] font-bold">{t('header.logout')}</span>
        </button>
      </div>
    </div>
  );
